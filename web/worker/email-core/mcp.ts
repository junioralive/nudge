...
type McpEnv = Cloudflare.Env & WorkerEnv;
...
/** Streamable HTTP MCP handler mounted by the Nudge Worker at /email/mcp. */
export const emailMcpHandler = MyMCP.serve("/email/mcp");
