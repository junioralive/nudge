/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=../wrangler.jsonc` (hash: 0aebd47850fa097d0534a93f6f8d6725)
...
interface __BaseEnv_Env {
	...
	NUDGE_PROFILE_NAME: "Junior";
	SECOND_BRAIN_URL: "https://memory.junioralive.in";
	VAPID_SUBJECT: "https://nudge.junioralive.in";
	MCP_OBJECT: DurableObjectNamespace<import("./worker/index").MyMCP>;
	MEMORY_MCP_OBJECT: DurableObjectNamespace<import("./worker/index").MemoriesMCP>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "MyMCP" | "MemoriesMCP";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_TIMEZONE" | "NUDGE_PROFILE_NAME" | "SECOND_BRAIN_URL" | "VAPID_SUBJECT">> {}
}
